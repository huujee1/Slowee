...
#define TIME_YELLOW		3		// 3초 300ms * 10
#define TIME_RED		30		// 3초 3000ms
const float THRE_GYRO =	60.0;

char* imageList[12] = {"signal_green.png","signal_red.png","signal_yello.png",
...
void start_cairo_drawing(void)
{
	...
	snprintf(sample_filepath, 256, "%s/%s", resource_path, imageList[imageIdx]);
	free(resource_path);
